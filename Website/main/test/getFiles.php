<?php
    ...
    if ($_SESSION["uid"] != NULL)
    {
	    ...
	    foreach($res as $file){
                ...
                echo '<td>';
                echo '3/27/2026';       //Date Here
                echo '</td>';

                echo '<td>';
                echo '1MB';             //File size here
                echo '</td>';
